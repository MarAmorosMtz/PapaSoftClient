...
public class AddHorarioAsesorController extends Observable {
    ...
    public void initialize() {
        cargarDiasSemana(diaLibre);
        cargarHoras(horaLibre);
    }
    ...
    private void guardar(){
        HorarioAsesorBase horario = new HorarioAsesorBase(this.horaLibre.getValue(),this.diaLibre.getValue(),periodo,asesor);
